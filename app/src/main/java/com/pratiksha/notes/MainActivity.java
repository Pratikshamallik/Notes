...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences=getApplicationContext().getSharedPreferences("com.pratiksha.notes", Context.MODE_PRIVATE);
        ...
        listVeiw.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
